...
<div className={` ${mode===true?"bg-dark":null}`}>
   ...
   <h4 className="bg-light p-1 px-2 pb-2  rounded-1" onClick={logout}><i class="fa fa-sign-out" aria-hidden="true"></i><small>log-out</small></h4>
     ...
     <div className={`DRKButton ${mode===false?"btn-dark":"btn-light"} btn`}><input type="checkbox" className={`  `} onClick={darkmodebtn} /><span className="">{mode===false?"Dark Mode":"Ligth Mode"} </span> </div>
